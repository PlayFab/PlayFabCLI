...
// This namespace contains request/result models for undocumented PlayFab Tools API
namespace PlayFabToolSDK.Models
{

    public class RegisterAccountRequest : PlayFabRequestCommon
    {
    ...
    public class LoginRequest : PlayFabRequestCommon
    {
        public string Email { get; set; }
        public string Password { get; set; }
    ...
    public class LogoutRequest : PlayFabRequestCommon
    {
    ...
    public class GetStudiosRequest : PlayFabRequestCommon
    {
        public string DeveloperClientToken { get; set; }
    }
    ...
    public class CreateTitleRequest : PlayFabRequestCommon
    {
        public string DeveloperClientToken { get; set; }
